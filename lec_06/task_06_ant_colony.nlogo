...
to go
  ask ants [
    ; Если муравей находится в гнезде или в источнике пищи, то устанавливаем уровень его феромона ph равным 0.1
...
to put-pheromone
  ; Если текущее состояние муравья — поиск пищи
  if state = "forward" [
    set ph-n ph-n + ph
...
to rotate-ant
  ...
  ; если муравей нашел источник еды
  if p-type = "food" [
    set state "backward"
    set color blue
    rt 180
  ...
  ; Если муравей идет к источнику еды
  if state = "forward" [
  ...
  ; Муравей выбирает патч в конусе видимости с радиусом от vision / 2 до vision и углом angle,
  ; имеющий максимальный уровень феромона, соответствующего текущей цели муравья
